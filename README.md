...
- 慢 SQL 优化流程 SOP
- 连接数问题分析 SOP
- MarkdownSkillParser: 从 Markdown 文档动态生成 Skill
...
│   │   ├── sops/                # SOP 定义
│   │   │   └── cpu_sop.py       # CPU SOP
│   │   └── docs/                # Markdown Skill 文档
│   │       └── cpu_analysis.md  # CPU 分析 SOP (Markdown)
│   │
│   ├── agent/                   # Agent 自我迭代模块
│   │   ├── base.py              # BaseAgent, IterationStrategy
│   │   ├── iteration.py         # IterationLoop
...
│   │   ├── instance_platform.py # 实例管理平台 API
│   │   ├── vector_store.py      # ChromaDB 向量存储
│   │   └── models.py            # Pydantic 数据模型
│   ├── tools/                   # 工具层 (8个核心工具)
│   ├── scheduler/               # Django + Celery 调度器
│   ├── api/                     # FastAPI 接口
│   └── utils/                   # 工具函数
│
├── tests/
...
│   ├── test_agent/              # Agent 迭代测试
│   ├── test_hermes/             # Hermes 测试
│   └── ...
│
├── knowledge/mysql/             # MySQL 知识库
└── docs/architecture/           # 架构文档 (7个SVG图)
```
